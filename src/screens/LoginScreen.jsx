...
import { StyleSheet, View, Text, TouchableOpacity, ToastAndroid, Keyboard } from 'react-native';

import { CustomInput, CustomPassInput } from '../components/common';
import { Color, FontSize, Padding } from '../components/styles/GlobalStyles';
import { axiosPost } from '../configs';
import { authIdKey } from '../constants/constant';
import { AppContext } from '../contexts';

const LoginScreen = () => {
  const navigation = useNavigation();
  const { setIsLogin } = useContext(AppContext);
  const { setIsFirstLogin } = useContext(AppContext);
